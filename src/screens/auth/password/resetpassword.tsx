...
import { Button, DarkTheme, FloatingTextInput, Header, LightTheme, TextView } from "@components/index";
		...
		<TouchableWithoutFeedback>
			<KeyboardAwareScrollView
				contentContainerStyle={{
					flexGrow: 1,
					backgroundColor: theme === "dark" ? currentTheme.background : Colors.SECONDARY[100],
				}}
				...
				<ImageBackground style={{ width: "100%", height: "100%" }} resizeMode="cover" source={Images.ic_passwordimg}>
					<View style={[styles.container, { paddingTop: insets.top, bottom: hp(3) }]}>
						...
						<View style={{ justifyContent: "center", alignItems: "flex-start", left: hp(5) }}>
							...
							<TextView style={[styles.apptitle, { ...Typography.BodyRegular12, textAlign: "left" }]}>
						...
						<View style={styles.panel}>
							<View style={styles.inputWrapper}>
								<FloatingTextInput
									...
									{...({ secureTextEntry: securePassword } as Record<string, boolean>)}
									{...({
										righticon: secureConfirmPassword ? Images.ic_eyeopen : Images.ic_eyeclose,
							...
							<View style={styles.inputWrapper}>
								<FloatingTextInput
									...
									{...({ secureTextEntry: secureConfirmPassword } as Record<string, boolean>)}
									{...({
										righticon: secureConfirmPassword ? Images.ic_eyeopen : Images.ic_eyeclose,
						...
						<Button
							...
							titleStyle={{ color: Colors.SECONDARY[100], ...Typography.BodyBold15 }}
							title="Reset Password"
							gradientColors={[Colors.PRIMARY[100], Colors.PRIMARY[100]]}
						/>
						<View style={styles.alreadyaccount}>
							<TextView style={styles.accounttext}>Remember your password?</TextView>
